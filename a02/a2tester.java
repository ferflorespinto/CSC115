...
public class a2tester
{
	...
	public static void testRemoveAt()
	{
		...
		System.out.println("removing element -: " + l1 + " size: " + l1.size());		
		l1.removeAt(5);
		System.out.println("removing element 5: " + l1 + " size: " + l1.size());		
		displayResults(l1.toString().equals("{1,3,6,9,4,22,5,10,15}"));
		l1.removeAt(2);
		System.out.println("removing element 2: " + l1 + " size: " + l1.size());
		l1.removeAt(0);
		System.out.println("removing element 0: " + l1 + " size: " + l1.size());		
		l1.removeAt(4);
		System.out.println("removing element 4: " + l1 + " size: " + l1.size());		
